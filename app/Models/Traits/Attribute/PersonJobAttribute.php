...
trait PersonJobAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.person_job.show', $this) .
    ...
    /**
     * @return string  person_job
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.person_job.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.person_job.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" person_job="group" aria-label="PersonJob Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
