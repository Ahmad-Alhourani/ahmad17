...
trait PersonAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.person.destroy', $this) .
            '"
			 data-method="delete"
     ...
     * @return  string
     */
    public function getJobsButtonAttribute()
    {
        return '<a href="' .
            route('admin.job.person', $this) .
            ' " class="dropdown-item">' .
            __('Jobs') .
            '</a> ';
    }
    ...
    {
        return '<div
       class="btn-group btn-group-sm" person="group" aria-label="Person Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
