<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        {{--start_Person_start--}}
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/persons')) }}" href=" {{ route('admin.person.index') }}"><i class="icon-list"></i> {{ __('menus.backend.sidebar.persons') }}</a>
            </li>
            {{--end_Person_end--}}
